...
export default abstract class ApiService {
  ...
  constructor() {
    ...
    // use serverless_functions_domain_flex_insights_for_agents from ui_attributes, or .env or set as undefined
    ...
    if (custom_data?.serverless_functions_domain_flex_insights_for_agents)
      this.serverlessDomain = custom_data.serverless_functions_domain_flex_insights_for_agents;
    ...
    if (!this.serverlessDomain)
      console.error(
        "serverless_functions_domain_flex_insights_for_agents is not set in flex config or env file"
      );
  }
