...
describe('utils/common/ApiService', () => {
  ...
  it('should provide access to the configured serverless domain', () => {
    ...
    const { serverless_functions_domain_flex_insights_for_agents } = ui_attributes as UIAttributes;
    expect(TestService.serverlessDomain).toBe(serverless_functions_domain_flex_insights_for_agents);
  });
